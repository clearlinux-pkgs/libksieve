...
Version  : 22.08.2
Release  : 44
URL      : https://download.kde.org/stable/release-service/22.08.2/src/libksieve-22.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.2/src/libksieve-22.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.2/src/libksieve-22.08.2.tar.xz.sig
...
%prep
%setup -q -n libksieve-22.08.2
cd %{_builddir}/libksieve-22.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665767240
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5KManageSieve.so.5.21.2
/usr/lib64/libKF5KSieve.so.5
/usr/lib64/libKF5KSieve.so.5.21.2
/usr/lib64/libKF5KSieveUi.so.5
/usr/lib64/libKF5KSieveUi.so.5.21.2
