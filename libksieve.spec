...
Version  : 23.08.3
Release  : 72
URL      : https://download.kde.org/stable/release-service/23.08.3/src/libksieve-23.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.3/src/libksieve-23.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.3/src/libksieve-23.08.3.tar.xz.sig
...
%prep
%setup -q -n libksieve-23.08.3
cd %{_builddir}/libksieve-23.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702018907
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim5KManageSieve.so.5.24.3
/V3/usr/lib64/libKPim5KSieve.so.5.24.3
/V3/usr/lib64/libKPim5KSieveUi.so.5.24.3
/usr/lib64/libKPim5KManageSieve.so.5
/usr/lib64/libKPim5KManageSieve.so.5.24.3
/usr/lib64/libKPim5KSieve.so.5
/usr/lib64/libKPim5KSieve.so.5.24.3
/usr/lib64/libKPim5KSieveUi.so.5
/usr/lib64/libKPim5KSieveUi.so.5.24.3
