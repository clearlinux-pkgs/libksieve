...
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/libksieve-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/libksieve-24.12.1.tar.xz.sig
...
%setup -q -n libksieve-24.12.1
cd %{_builddir}/libksieve-24.12.1
pushd ..
cp -a libksieve-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736732377
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6KManageSieve.so.6.3.1
/V3/usr/lib64/libKPim6KSieve.so.6.3.1
/V3/usr/lib64/libKPim6KSieveCore.so.6.3.1
/V3/usr/lib64/libKPim6KSieveUi.so.6.3.1
/usr/lib64/libKPim6KManageSieve.so.6
/usr/lib64/libKPim6KManageSieve.so.6.3.1
/usr/lib64/libKPim6KSieve.so.6
/usr/lib64/libKPim6KSieve.so.6.3.1
/usr/lib64/libKPim6KSieveCore.so.6
/usr/lib64/libKPim6KSieveCore.so.6.3.1
/usr/lib64/libKPim6KSieveUi.so.6
/usr/lib64/libKPim6KSieveUi.so.6.3.1
