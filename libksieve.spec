...
Version  : 25.04.2
Release  : 116
URL      : https://download.kde.org/stable/release-service/25.04.2/src/libksieve-25.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/libksieve-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/libksieve-25.04.2.tar.xz.sig
...
%setup -q -n libksieve-25.04.2
cd %{_builddir}/libksieve-25.04.2
pushd ..
cp -a libksieve-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749577417
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6KManageSieve.so.6.4.2
/V3/usr/lib64/libKPim6KSieve.so.6.4.2
/V3/usr/lib64/libKPim6KSieveCore.so.6.4.2
/V3/usr/lib64/libKPim6KSieveUi.so.6.4.2
/usr/lib64/libKPim6KManageSieve.so.6
/usr/lib64/libKPim6KManageSieve.so.6.4.2
/usr/lib64/libKPim6KSieve.so.6
/usr/lib64/libKPim6KSieve.so.6.4.2
/usr/lib64/libKPim6KSieveCore.so.6
/usr/lib64/libKPim6KSieveCore.so.6.4.2
/usr/lib64/libKPim6KSieveUi.so.6
/usr/lib64/libKPim6KSieveUi.so.6.4.2
