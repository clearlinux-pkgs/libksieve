...
Version  : 20.08.2
Release  : 23
URL      : https://download.kde.org/stable/release-service/20.08.2/src/libksieve-20.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.08.2/src/libksieve-20.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.2/src/libksieve-20.08.2.tar.xz.sig
...
%prep
%setup -q -n libksieve-20.08.2
cd %{_builddir}/libksieve-20.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602717615
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libksieve-20.08.2/COPYING %{buildroot}/usr/share/package-licenses/libksieve/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/libksieve-20.08.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/libksieve/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
%find_lang kio_sieve
...
/usr/lib64/libKF5KManageSieve.so.5.15.2
/usr/lib64/libKF5KSieve.so.5
/usr/lib64/libKF5KSieve.so.5.15.2
/usr/lib64/libKF5KSieveUi.so.5
/usr/lib64/libKF5KSieveUi.so.5.15.2
