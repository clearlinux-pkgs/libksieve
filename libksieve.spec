...
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/libksieve-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/libksieve-24.05.0.tar.xz.sig
...
%setup -q -n libksieve-24.05.0
cd %{_builddir}/libksieve-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716583767
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6KManageSieve.so.6.1.0
/V3/usr/lib64/libKPim6KSieve.so.6.1.0
/V3/usr/lib64/libKPim6KSieveCore.so.6.1.0
/V3/usr/lib64/libKPim6KSieveUi.so.6.1.0
/usr/lib64/libKPim6KManageSieve.so.6
/usr/lib64/libKPim6KManageSieve.so.6.1.0
/usr/lib64/libKPim6KSieve.so.6
/usr/lib64/libKPim6KSieve.so.6.1.0
/usr/lib64/libKPim6KSieveCore.so.6
/usr/lib64/libKPim6KSieveCore.so.6.1.0
/usr/lib64/libKPim6KSieveUi.so.6
/usr/lib64/libKPim6KSieveUi.so.6.1.0
