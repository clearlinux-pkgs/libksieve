...
%prep
%setup -q -n libksieve-23.08.4
cd %{_builddir}/libksieve-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703001197
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim5KManageSieve.so.5.24.4
/V3/usr/lib64/libKPim5KSieve.so.5.24.4
/V3/usr/lib64/libKPim5KSieveUi.so.5.24.4
/usr/lib64/libKPim5KManageSieve.so.5
/usr/lib64/libKPim5KManageSieve.so.5.24.4
/usr/lib64/libKPim5KSieve.so.5
/usr/lib64/libKPim5KSieve.so.5.24.4
/usr/lib64/libKPim5KSieveUi.so.5
/usr/lib64/libKPim5KSieveUi.so.5.24.4
