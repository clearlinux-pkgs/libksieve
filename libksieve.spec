...
%setup -q -n libksieve-25.04.1
cd %{_builddir}/libksieve-25.04.1
pushd ..
cp -a libksieve-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747186489
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6KManageSieve.so.6.4.1
/V3/usr/lib64/libKPim6KSieve.so.6.4.1
/V3/usr/lib64/libKPim6KSieveCore.so.6.4.1
/V3/usr/lib64/libKPim6KSieveUi.so.6.4.1
/usr/lib64/libKPim6KManageSieve.so.6
/usr/lib64/libKPim6KManageSieve.so.6.4.1
/usr/lib64/libKPim6KSieve.so.6
/usr/lib64/libKPim6KSieve.so.6.4.1
/usr/lib64/libKPim6KSieveCore.so.6
/usr/lib64/libKPim6KSieveCore.so.6.4.1
/usr/lib64/libKPim6KSieveUi.so.6
/usr/lib64/libKPim6KSieveUi.so.6.4.1
