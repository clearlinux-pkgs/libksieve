...
Version  : 23.08.2
Release  : 68
URL      : https://download.kde.org/stable/release-service/23.08.2/src/libksieve-23.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/libksieve-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/libksieve-23.08.2.tar.xz.sig
...
%prep
%setup -q -n libksieve-23.08.2
cd %{_builddir}/libksieve-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697407278
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim5KManageSieve.so.5.24.2
/V3/usr/lib64/libKPim5KSieve.so.5.24.2
/V3/usr/lib64/libKPim5KSieveUi.so.5.24.2
/usr/lib64/libKPim5KManageSieve.so.5
/usr/lib64/libKPim5KManageSieve.so.5.24.2
/usr/lib64/libKPim5KSieve.so.5
/usr/lib64/libKPim5KSieve.so.5.24.2
/usr/lib64/libKPim5KSieveUi.so.5
/usr/lib64/libKPim5KSieveUi.so.5.24.2
