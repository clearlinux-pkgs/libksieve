...
Version  : 22.08.0
Release  : 42
URL      : https://download.kde.org/stable/release-service/22.08.0/src/libksieve-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/libksieve-22.08.0.tar.xz
...
%prep
%setup -q -n libksieve-22.08.0
cd %{_builddir}/libksieve-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661556246
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5KManageSieve.so.5.21.0
/usr/lib64/libKF5KSieve.so.5
/usr/lib64/libKF5KSieve.so.5.21.0
/usr/lib64/libKF5KSieveUi.so.5
/usr/lib64/libKF5KSieveUi.so.5.21.0
