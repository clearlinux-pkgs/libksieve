...
Source0  : https://download.kde.org/stable/release-service/22.08.1/src/libksieve-22.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.1/src/libksieve-22.08.1.tar.xz.sig
...
%prep
%setup -q -n libksieve-22.08.1
cd %{_builddir}/libksieve-22.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662785082
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5KManageSieve.so.5.21.1
/usr/lib64/libKF5KSieve.so.5
/usr/lib64/libKF5KSieve.so.5.21.1
/usr/lib64/libKF5KSieveUi.so.5
/usr/lib64/libKF5KSieveUi.so.5.21.1
