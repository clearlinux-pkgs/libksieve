...
Version  : 25.04.0
Release  : 113
URL      : https://download.kde.org/stable/release-service/25.04.0/src/libksieve-25.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/libksieve-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/libksieve-25.04.0.tar.xz.sig
...
%setup -q -n libksieve-25.04.0
cd %{_builddir}/libksieve-25.04.0
pushd ..
cp -a libksieve-25.04.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744996235
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6KManageSieve.so.6.4.0
/V3/usr/lib64/libKPim6KSieve.so.6.4.0
/V3/usr/lib64/libKPim6KSieveCore.so.6.4.0
/V3/usr/lib64/libKPim6KSieveUi.so.6.4.0
/usr/lib64/libKPim6KManageSieve.so.6
/usr/lib64/libKPim6KManageSieve.so.6.4.0
/usr/lib64/libKPim6KSieve.so.6
/usr/lib64/libKPim6KSieve.so.6.4.0
/usr/lib64/libKPim6KSieveCore.so.6
/usr/lib64/libKPim6KSieveCore.so.6.4.0
/usr/lib64/libKPim6KSieveUi.so.6
/usr/lib64/libKPim6KSieveUi.so.6.4.0
